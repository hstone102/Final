...
<div id="employee" style="display:none">
  ...
  <div class="control centertext m-t-lg m-b-xxl">
    <button class="button is-info" onClick="selection3()">Find Client</button>
  </div>
  <script>
  ...
  function selection3 () {
    ...
    var x = document.getElementById("specificEmployee");
   ...
   <div id="specificEmployee" style="display:none">
     <h2 class="textmedium m-b-xl">Select as many as you would like...</h2>
